...
public class DetailFood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            textView_price.setText(bundle.getString("1price"));
            textView_nameProduct.setText(bundle.getString("1name"));
            textView_description.setText(bundle.getString("1description"));
            Glide.with(this).load(bundle.getString("1image")).into(imageView);
        }
