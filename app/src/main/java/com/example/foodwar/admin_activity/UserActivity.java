...
import com.example.foodwar.adapter.ListUserAdapter;
import com.example.foodwar.databinding.ActivityUserBinding;
import com.example.foodwar.databinding.UserDialogBinding;
import com.example.foodwar.databinding.UserInsertBinding;
import com.example.foodwar.models.User;
...
public class UserActivity extends AppCompatActivity {
    ...
    private void onSetupDetailDiaog(User user){
        ...
        Picasso.get().load(user.getAvata())
